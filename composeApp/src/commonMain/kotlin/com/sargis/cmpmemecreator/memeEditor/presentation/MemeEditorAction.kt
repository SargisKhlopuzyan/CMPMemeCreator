...
sealed interface MemeEditorAction {
    ...
    data object OnConfirmLeavingWithoutSaving : MemeEditorAction
    data object OnDismissLeavingWithoutSaving : MemeEditorAction
    ...
    data class OnMemeTextChanged(val id: String, val text: String) : MemeEditorAction
