package com.sargis.cmpmemecreator.memeGallery.presentation
...
import com.sargis.cmpmemecreator.core.presentation.memeTemplates
...
fun MemeGalleryScreen(
    onMemeTemplateSelected: (memeTemplate: MemeTemplate) -> Unit
) {
    Scaffold(
        topBar = {
            TopAppBar(
